"""Component 5 (Score / Accuracy Tracker) v4
I finalised the code from v3 by adding the accuracy percentage. I also changed some of the print statements so it
matches with the other versions of level 1 and 2. (e.g. when the user presses 'x').
"""
