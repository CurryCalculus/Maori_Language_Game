"""Component 5 (Score / Accuracy Tracker) v3
This version tells the user how many questions they have attempted and how many they got it right.
I will add the user's accuracy percentage in the next version.
"""
...
while True:
    ...
    if quiz_type == 'months':
        ...
        if user_input.lower() == "x":
            print("Good job! You attempted", num_attempted, "questions and got", num_correct, "right. Come back again after some rest!")
            break
    ...
    if consecutive_correct >= 10:
        print("Congratulations! You've answered 10 questions correctly in a row!")
